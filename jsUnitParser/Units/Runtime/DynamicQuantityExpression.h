...
namespace DNVS {namespace MoFa { namespace Units { namespace Parser {
    ...
    class DynamicQuantityExpression : public DynamicUnitExpression
    {
    public:
        DynamicQuantityExpression(IUnitHelper& helper, ExpressionPointer lhs, ExpressionPointer rhs, CodeLocation const &loc);
