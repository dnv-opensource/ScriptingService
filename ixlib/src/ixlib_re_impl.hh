...
template <class T>
ixion::regex<T>::backref_stack::rewind_info ixion::regex<T>::backref_stack::getRewindInfo() const
{
    return Stack.size();
}
...
// regex::matcher -------------------------------------------------------------
template <class T>
ixion::regex<T>::matcher::matcher() : Next(NULL)
{
}
...
template <class T>
ixion::regex<T>::sequence_matcher::sequence_matcher(T const &matchstr) : MatchStr(matchstr)
{
...
template <class T>
ixion::regex<T>::backref_matcher::backref_matcher(TIndex backref) : Backref(backref)
{
}
...
// regex ----------------------------------------------------------------------
template <class T>
ixion::regex<T>::regex() : MatchIndex(0), MatchLength(0)
{
}

template <class T>
ixion::regex<T>::regex(regex const &src) : ParsedRegex(src.ParsedRegex->duplicate()), MatchIndex(0), MatchLength(0)
{
}
