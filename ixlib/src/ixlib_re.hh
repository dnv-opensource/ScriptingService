...
#ifdef _MSC_VER
/*
Because of a bug in MSC, nested template classes can not be implemented outside the class definition.
ixlib_re_inline contains ixlib_re.hpp and most of ixlib_re_impl.hpp
*/
#include <srcWin\ixlib_re_inline.hpp>
#else
