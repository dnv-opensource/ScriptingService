...
namespace ixion { namespace javascript {
    ...
    class jsValue_delegate : public common_base_value 
    {
    public:
        jsValue_delegate(const mofa::ref<jsValue>& object, const mofa::ref<jsValue>& method);
        virtual ~jsValue_delegate();
